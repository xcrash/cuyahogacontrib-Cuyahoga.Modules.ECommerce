...
<html>
	<head>
		<title>igenticsCMS Site Administration</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<p>Manage the properties of the page. Use the buttons on the bottom
			...
			<div class="tabbertab">
				...
				<table>
					<tr>
						<td style="WIDTH: 100px">Page menu title</td>
					...
					<tr>
						...
						<td><asp:textbox id="txtLongTitle" runat="server" width="300px" /></td>
					</tr>
					<tr>
						<td>Friendly url</td>
					...
					<tr>
						<td></td>
						<td><asp:checkbox id="chkLink" runat="server" autopostback="True" text="The page is a link to an external url"></asp:checkbox><asp:panel id="pnlLink" runat="server" visible="False">
								<table>
									<tr>
			...
			<asp:panel id="pnlMenus" runat="server" cssclass="group" visible="False">
				...
				<em>You're editing a root page, so you can also attach on or more custom menu's.</em>
				<table class="tbl">
			...
			<asp:panel id="pnlSections" runat="server" cssclass="group">
			 ...
			 <div class="tabbertab">
				...
				<table class="tbl">
					...
					<tr>
					<td><asp:checkbox id="chkPropagateToSections" runat="server" text="Propagate security settings to sections"></asp:checkbox>
					</td>
					<td>
				...
				<div><p><asp:button id="btnSave" runat="server" text="Save"></asp:button>
			...
			<asp:button id="btnDelete" runat="server" causesvalidation="False" text="Delete"></asp:button></p></div>
				</div>
