<%@ Control Language="c#" AutoEventWireup="false" Codebehind="OrderList.ascx.cs" Inherits="Cuyahoga.Modules.ECommerce.Albion.Web.Views.OrderList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
