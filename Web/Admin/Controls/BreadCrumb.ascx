...
<itemtemplate><%#(Container.ItemIndex == 0) ? ("") : (NodeSeperator + ((ShowCatItemLink(Container) ? ("<a href=\"CatalogueBrowser.aspx?NodeId=19&SectionId=41&cat=" + ((ICategory)Container.DataItem).NodeID + "\">") : "") + ((ICategory)Container.DataItem).Name + ((ShowCatItemLink(Container) ? "</a>" : ""))))%> </itemtemplate>
