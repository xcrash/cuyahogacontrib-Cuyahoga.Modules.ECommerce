    ...
    public class ProductEdit : ModuleAdminBasePage {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            try {
                ...
                Page.ClientScript.RegisterClientScriptInclude("tabs", "js/tabpane.js");
                Page.ClientScript.RegisterClientScriptInclude("tabs1", "css/tab.webfx.css");//cant remmebr whether this works /*fixme*/
                ...
                if (ProductID > 0) {
                    ...
                    ICatalogueNode n = new CatalogueNode();
                    n.NodeID = CatID;
                    ctlBreadCrumb.RenderBreadCrumbTrail(controller.CatalogueViewer.GetCategoryBreadCrumb(n));
                }
        ...
        private void btnSave_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                if (!string.IsNullOrEmpty(productEditor.txtProductID.Text)) {
                    p = controller.CatalogueViewer.GetECommerceProduct(1, "uk", Convert.ToInt64(productEditor.txtProductID.Text));
        ...
        public bool SaveEditedProduct(DbProduct p, List<ProductAttributeOptionValue> paovList, List<IImage> images, List<ProductRelation> crossSellList, List<ProductDocument> documentList, List<ProductSynonym> synonymList) {
            ...
            if (p.Attributes!= null) {
                foreach (ProductAttributeOptionValue paov in p.Attributes) {
                    if (!controller.EditService.DeleteProductAttribute(controller.Section.Node.Site.Id, paov)) {
                        return false;
                    }
                }
            }
            ...
            if (synonymList != null) {
                foreach (ProductAttributeOptionValue paov in paovList) {
