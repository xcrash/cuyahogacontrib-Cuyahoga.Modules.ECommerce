...
namespace Cuyahoga.Modules.ECommerce.Web.Admin {
    ...
    public partial class CatalogueBrowser : ModuleAdminBasePage {
        ...
        private const int PROD_DEPTH = 3;
        private ICatalogueNodeView cat = null;
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (CatID > 0) {
                cat = controller.CatalogueViewer.GetCatalogueNodeView(controller.Section.Node.Site.Id, controller.Section.Node.Culture, CatID);
            } else {
                cat = controller.CatalogueViewer.GetRootCatalogueNodeView(controller.Section.Node.Site.Id, controller.Section.Node.Culture);
