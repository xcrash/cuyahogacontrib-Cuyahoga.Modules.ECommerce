        ...
        <asp:repeater runat="server" id="rptCategories">
			...
			<itemtemplate>
				<tr<%#(Container.ItemIndex % 2 == 1) ? " class=\"even\"" : ""%>>
					<td>
						<h3><a href="CatalogueBrowser.aspx<%#GetBaseQueryString()%>&cat=<%#((ICategory)Container.DataItem).NodeID%>"><%#((ICategory)Container.DataItem).Name%></a></h3>
					</td>
                    <td><a href="CategoryEdit.aspx<%#GetBaseQueryString()%>&cat=<%#((ICategory)Container.DataItem).NodeID%>"><img src="../../images/folder_edit.png" alt="Edit Category"/></a></td>
                    <td><a href="CategoryDelete.aspx<%#GetBaseQueryString()%>&cat=<%#((ICategory)Container.DataItem).NodeID%>"><img src="../../images/folder_delete.png" alt="Delete Category"/></a></td>
                    <td><a href="CategoryMove.aspx<%#GetBaseQueryString()%>&cat=<%#((ICategory)Container.DataItem).NodeID%>&direction=Up"><img src="<%=Cuyahoga.Web.Util.UrlHelper.GetSiteUrl()%>/admin/images/arrow_up.png" border="0"/></a> <a href="CategoryMove.aspx<%#GetBaseQueryString()%>&cat=<%#((ICategory)Container.DataItem).NodeID%>&direction=Down"><img src="<%=Cuyahoga.Web.Util.UrlHelper.GetSiteUrl()%>/admin/images/arrow_down.png" border="0"/></a>
				</tr>
			</itemtemplate>
			<footertemplate>
				</tbody>
			...
			<itemtemplate>
				<tr<%#(Container.ItemIndex % 2 == 1) ? " class=\"even\"" : ""%>>
				    ...
				    <td><a href="ProductMove.aspx<%#GetBaseQueryString()%>&pid=<%#((IProductSummary)Container.DataItem).ProductID%>&cat=<%=CatID%>&direction=Up"><img src="<%=Cuyahoga.Web.Util.UrlHelper.GetSiteUrl()%>/admin/images/arrow_up.png" border="0"/></a> <a href="ProductMove.aspx<%#GetBaseQueryString()%>&pid=<%#((IProductSummary)Container.DataItem).ProductID%>&cat=<%=CatID%>&direction=Down"><img src="<%=Cuyahoga.Web.Util.UrlHelper.GetSiteUrl()%>/admin/images/arrow_down.png" border="0"/></a></td>
				</tr>
			</itemtemplate>
			<footertemplate>
				</tbody>
