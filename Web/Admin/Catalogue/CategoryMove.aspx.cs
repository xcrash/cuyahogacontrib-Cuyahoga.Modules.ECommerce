...
namespace Cuyahoga.Modules.ECommerce.Web.Admin {
    ...
    public class CategoryMove : ModuleAdminBasePage {
        ...
        private void MoveUp(Category cat) {
            ...
            ICatalogueNodeView nodeView = controller.CatalogueViewer.GetCatalogueNodeView(controller.Section.Node.Site.Id, controller.Section.Node.Culture, cat.ParentCategory.CategoryID);
        ...
        private short GetNodeIndex(Category cat, ICatalogueNodeView nodeView) {
            ...
            foreach (ICatalogueNode node in nodeView.ChildNodes) {
        ...
        private void SwapCategories(ICatalogueNodeView nodeView, short catIndex) {
