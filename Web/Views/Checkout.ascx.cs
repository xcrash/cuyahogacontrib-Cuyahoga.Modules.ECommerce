namespace Cuyahoga.Modules.ECommerce.Web.Views {
    ...
    public class Checkout : Cuyahoga.Modules.ECommerce.Core.GenericModuleControl {
        ...
        private void Page_Load(object sender, System.EventArgs e) {
            ...
            try {
                ...
                if (!IsPostBack) {
                    ...
                    PopulateAddressDetails(basketOrder);
        ...
        private void PopulateAddressDetails(BasketDecorator basketOrder) {
        ...
        private void PopulateUserDetails(BasketDecorator basketOrder, IStoreContext context) {
            ...
            if (basketOrder.UserDetails != null || basketOrder.AltUserDetails != null) {
                ...
                if (context != null && context.WebStoreUser != null && context.WebStoreUser != null) {
        ...
        protected virtual void PerformStepActions(CheckoutStep oldStep, CheckoutStep newStep, BasketDecorator basketOrder) {
           ...
           // SetBreadCrumbImage(newStep);

        }

        protected void SetBreadCrumbImage(CheckoutStep step) {

            string ext = ".jpg";

            switch (step) {
                case CheckoutStep.ShowCompletedOrder:
                    imgBreadCrumb.ImageUrl = Page.ResolveUrl("/Templates/Albion/Images/" + BreadCrumbImage.CreditOrderConfirmation + ext);
                    imgBreadCrumb.Visible = true;
                    imgTradeBreadCrumb.Visible = false;
                    break;
                case CheckoutStep.ConfirmDetails:
                    imgBreadCrumb.ImageUrl = Page.ResolveUrl("/Templates/Albion/Images/" + BreadCrumbImage.CreditUserDetails + ext);
                    imgBreadCrumb.Visible = true;
                    imgTradeBreadCrumb.Visible = false;
                    break;
                case CheckoutStep.ProceedToPayment:
                    imgBreadCrumb.ImageUrl = Page.ResolveUrl("/Templates/Albion/Images/" + BreadCrumbImage.CreditCardDetails + ext);
                    imgBreadCrumb.Visible = true;
                    imgTradeBreadCrumb.Visible = false;
                    break;
                case CheckoutStep.ShowSubmittedOrder:
                    imgTradeBreadCrumb.ImageUrl = Page.ResolveUrl("/Templates/Albion/Images/" + BreadCrumbImage.TradeOrderConfirmation + ext);
                    imgBreadCrumb.Visible = false;
                    imgTradeBreadCrumb.Visible = true;
                    break;
                case CheckoutStep.EnterAccountDetails:
                    imgTradeBreadCrumb.ImageUrl = Page.ResolveUrl("/Templates/Albion/Images/" + BreadCrumbImage.TradeAccountDetails + ext);
                    imgBreadCrumb.Visible = false;
                    imgTradeBreadCrumb.Visible = true;
                    break;
                case CheckoutStep.EnterAddressDetails:
                ...
                default:
                    imgBreadCrumb.ImageUrl = Page.ResolveUrl("/Templates/Albion/Images/" + BreadCrumbImage.CreditPaymentType + ext);
                    imgBreadCrumb.Visible = true;
                    imgTradeBreadCrumb.Visible = false;
                    break;
            }
        ...
        protected virtual void CollectPayment(BasketDecorator basketOrder) {
            ...
            IPaymentProvider provider = EModule.PaymentProvider;
