namespace Cuyahoga.Modules.ECommerce.Web.Views {
    ...
    public class Checkout : Cuyahoga.Modules.ECommerce.Core.GenericModuleControl {
        ...
        private void Page_Load(object sender, System.EventArgs e) {
            ...
            try {
                ...
                if (!IsPostBack) {
                    ...
                    PopulateUserDetails(basketOrder);
                    ...
                    if (basketOrder.IsPurchased) {
                        ...
                        SetAndActionNewStep(CheckoutStep.SelectPaymentMethod, basketOrder);
                    }
                }
        ...
        private void PopulateUserDetails(BasketDecorator basketOrder) {
        ...
        protected virtual void CollectPayment(BasketDecorator basketOrder) {
            ...
            if (webProvider != null) {
                webProvider.TransferClientToPaymentPage(payment, PaymentRequestTypes.ImmediatePayment, false); // this should be extracted to a config file (the debug switch)
            } else {
                if (provider != null) {
        ...
        private void btnNext_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                //Damn those exceptions! They just won't go away!
            }
        }
