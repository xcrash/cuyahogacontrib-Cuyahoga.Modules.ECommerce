        ...
        private void Page_Load(object sender, System.EventArgs e) {
            ...
            try {
                ...
                if (CatMod.NodeID > 0) { //gets top level categories if no node supplied
                    cat = CatMod.CatalogueViewer.GetCategoryView(CatMod.Section.Node.Site.Id, CatMod.Section.Node.Culture, CatMod.NodeID);
                } else {
                    cat = CatMod.CatalogueViewer.GetRootCategoryView(CatMod.Section.Node.Site.Id, CatMod.Section.Node.Culture);
                }

                ctlProductList.TotalResults = cat.ProductList.Count;
                ...
                if (cat != null) {
                    ...
                    ctlProductList.Visible = IsProductList;
