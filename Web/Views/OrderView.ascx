<%@ Control Language="c#" AutoEventWireup="false" Codebehind="OrderView.ascx.cs" Inherits="Cuyahoga.Modules.ECommerce.Web.Views.OrderView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
