<%@ Control Language="c#" AutoEventWireup="false" Codebehind="OrderList.ascx.cs" Inherits="Cuyahoga.Modules.ECommerce.Web.Views.OrderList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
