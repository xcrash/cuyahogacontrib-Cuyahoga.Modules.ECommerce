<%@ Control Language="c#" AutoEventWireup="false" Codebehind="OrderView.ascx.cs" Inherits="Cuyahoga.Modules.ECommerce.Web.Controls.OrderView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<%@ Import Namespace="Cuyahoga.Modules.ECommerce.Util.Interfaces" %>
<%@ Import Namespace="Cuyahoga.Modules.ECommerce.Util" %>
<div id="paymentMethods" class="confirmation form">
...
<div id="orderDetails" class="confirmation list">
