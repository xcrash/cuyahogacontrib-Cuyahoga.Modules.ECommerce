...
<asp:placeholder id="phError" runat="server" Visible="false">
	<tr>
		<td colspan="3"><p class="warning"><%=GetText("invalid postal address")%></p></td>
	</tr> 
</asp:placeholder>
...
<tr>
	...
	<td><asp:requiredfieldvalidator ID="rfvCompanyName" Runat="Server" ControlToValidate="txtContactName" Display="dynamic" /></td>
</tr>
</asp:placeholder>
<tr>
	...
	<td><asp:RequiredFieldValidator ID="rfvAddress1" ControlToValidate="txtAddress1" display="dynamic" Runat="Server"/></td>
</tr>
<tr>
...
<tr>
	...
	<td><asp:RequiredFieldValidator ID="rfvCity" ControlToValidate="txtCity" display="dynamic" Runat="Server"/></td>
</tr>
<tr>
	...
	<td><asp:RequiredFieldValidator ID="rfvRegion" ControlToValidate="txtRegion" display="dynamic" Runat="Server"/></td>
</tr> 
<tr>
	...
	<td><asp:RequiredFieldValidator ID="rfvPostCode" ControlToValidate="txtPostcode" display="dynamic" Runat="Server"/></td>
</tr>
<tr>
	...
	<td>	<asp:RequiredFieldValidator ID="rfvCountry" ControlToValidate="ddlCountry" display="dynamic" Runat="server"/></td>
</tr>