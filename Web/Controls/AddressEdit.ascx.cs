    ...
    public class AddressEdit : LocalizedModuleConsumerControl, IAddress {
        ...
        private void Page_Load(object sender, System.EventArgs e) {
            if (!IsPostBack) {
                ...
                //Should be using the GetCountryName method in the util class but it does not work for some reason. FIXME
                ...
                foreach (string countryCode in IgCountryCode.CountryList) {
                    _countryList.Add(new Domain.Country(countryCode, GetText(IgCountryCode.COUNTRY_NAME_TRANSLATION_TAG_PREFIX + countryCode.ToLower())));
                }
