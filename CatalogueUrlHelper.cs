...
namespace Cuyahoga.Modules.ECommerce {
	...
	public class CatalogueUrlHelper {
        ...
        public virtual string GetCatalogueNodeUrlForKits(ICatalogueNode node) {
		...
		public virtual string GetCatalogueNodeUrl(ICatalogueNode node) {
        ...
        public virtual string GetProductUrl(IProductSummary summary) {
            if (summary != null) {
                ...
                try {
                    return GetCatalogueNodeUrl(_module.CatalogueViewer.GetRootCatalogueNodeView(_module.Section.Node.Site.Id, _module.Section.Node.Culture).CurrentNode.NodeID);
                } catch {
                    return "";
                }
            }
