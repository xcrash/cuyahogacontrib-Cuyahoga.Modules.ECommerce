        ...
        targetImageID, confirmButtonID, debugID)
{
    ...
    oSelection.style.left = "30px";
    oSelection.style.top = "40px";
    oSelection.style.width = (Math.floor(oCanvas.width / 4) * 3.5) + "px";
    oSelection.style.height = (Math.floor(oCanvas.height / 4) * 3.5) + "px";
