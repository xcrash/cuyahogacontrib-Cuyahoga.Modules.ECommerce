...
<head>
	...
	<script type="text/javascript" src="/leeCommerce/Templates/AnotherRed/js/niftytabs.js">
		</script>
		...
		window.onload=function(){
			...
			Nifty("ul#sections a","medium transparent top");
		}
</script>
	
	<script type="text/javascript" src="/leeCommerce/Templates/AnotherRed/js/lightbox.js"></script>
...
<body>
	<form id="t" method="post" runat="server">
		<div id="container">
			...
			<div id="main">
				<div id="globalmenu">
					<asp:placeholder id="navigationMenu" runat="server"></asp:placeholder>
				...
				<div id="side">
					...
					<div id="sidecontent">
						...
						<asp:placeholder id="configurator" runat="server"></asp:placeholder>
