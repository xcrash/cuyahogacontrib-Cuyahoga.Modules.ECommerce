...
namespace Cuyahoga.Modules.ECommerce.Util {
	...
	public class WebStoreContext : StoreContext {
        ...
        public const string SESSION_INFO_WEBSTORE_USER = "WEBSTORE_USER";
        ...
        public override WebStoreUser WebStoreUser {
            get {

                return (WebStoreUser)SessionInfo[SESSION_INFO_WEBSTORE_USER];
            }
            set {
                SessionInfo[SESSION_INFO_WEBSTORE_USER] = value;
            }
        }
