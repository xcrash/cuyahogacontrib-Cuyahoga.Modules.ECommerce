...
namespace Cuyahoga.Modules.ECommerce.Domain {
    ...
    #region IBasket Members
        ...
        public IBasketLine AddItem(Product product, System.Collections.Generic.IList<IAttributeSelection> optionList, int quantity) {
        ...
        public IBasketLine AddItem(Product product, int quantity) {
            return AddItem(product, quantity, BasketItemType.StandardItem);
        }

        public IBasketLine AddItem(Product product, int quantity, BasketItemType itemType) {
        ...
        public void RemoveItem(long basketLineID) {
        ...
        protected BasketItem GetItem(long basketLineID) {
