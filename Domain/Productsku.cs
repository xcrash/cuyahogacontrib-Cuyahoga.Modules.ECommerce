	...
	public class Productsku 
	{
		...
		public virtual string Sku
		{
			...
			set	
			{
				if ( value != null )
					if( value.Length > 128)
						throw new ArgumentOutOfRangeException("Invalid value for Sku", value, value.ToString());
				
				_isChanged |= (_sku != value); _sku = value;
			}
		}
		...
		public override bool Equals( object obj )
		{
			...
			Productsku castObj = (Productsku)obj; 
			return ( castObj != null ) &&
				( this._sku == castObj.Sku );
		}
